  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="absolute bottom-[8vh] left-[26vw]">
        <Button href="/page5" className="px-12 py-6 bg-pink-100 text-gray-800 text-3xl font-bold rounded-xl shadow-xl focus:outline-none focus:ring-2 focus:ring-pink-300 focus:ring-opacity-50 transform transition-transform duration-200 hover:scale-105 active:scale-95 hover:bg-pink-300">
          Let's Do This!
        </Button>
      </div>
    </div>
